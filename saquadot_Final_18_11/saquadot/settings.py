"""
Django settings for saquadot project.
...
SECRET_KEY = 'django-insecure-v_+g@!tcdy+g2%t463t&j6f2@$e(rv%n#3z&(567u9%m*(6*t8'
...
import os  # 👈 adicione isso no início do arquivo, se ainda não existir
